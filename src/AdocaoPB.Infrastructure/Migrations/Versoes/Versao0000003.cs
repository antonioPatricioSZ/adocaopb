...
[Migration((long)NumeroVersoes.CreateTableEnderecoUser, "Criar tabela enderecoUser")]
...
public class Versao0000003 : Migration
{
    ...
    public override void Up()
    {
        ...
        var tabela = VersionBase.InserirColunasPadrao(Create.Table("EnderecoUsers"));
        ...
        tabela
            ...
            .WithColumn("UserId").AsString(450).NotNullable()
                .ForeignKey("FK_Pets_AspNetUsers_UserId", "AspNetUsers", "Id")
